 ...
 */
public class Sounds {
    private static String path_enemysound = "src/lushaj_res/enemyhit.mp3";
    ...
    private static String path_check = "src/lushaj_res/checksound.mp3";
    ...
    private static String path_coin = "src/lushaj_res/coin.mp3";
